...
<div class="max-w-[50rem] flex flex-col mx-auto size-full">
    ...
    <main id="content">
      <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
        ...
        <p class="mt-3 text-gray-600 dark:text-neutral-400">Oups, quelque chose c'est mal passé.</p>
        <p class="text-gray-600 dark:text-neutral-400">Désolé, nous n'avon pas pu trouver votre page.</p>
    ...
    <footer class="mt-auto text-center py-5">
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        <p class="text-sm text-gray-500 dark:text-neutral-500">© SOMELEC Tous droits réservés.2025</p>
      </div>
    </footer>
    <!-- ========== END FOOTER ========== -->
  </div>

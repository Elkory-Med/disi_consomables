...
<div class="sm:col-span-3">
                    ...
                    <div class="sm:col-span-9">
                        <div class="mb-4">
                            ...
                            @else
                                <img src="{{ asset('images/placeholder-image.jpg') }}" alt="Image par défaut" class="h-48 w-48 object-cover rounded-lg">
                            @endif
                        </div>
...
@error('product_description') <span class="text-red-500">{{ $message }}</span> @enderror
                ...
                <button type="submit" 
                    ...
                    <span wire:loading.remove>Soumettre et Enregistrer</span>
